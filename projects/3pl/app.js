...
// Данные по Нигерии для DETAILED_COUNTRIES
NGA: {
    iso: 'NGA',
    emoji: '🇳🇬',
    name: 'Нигерия',
    region: 'afr',
    population: 237.5,            // млн (2025)[31]
    gdpPerCapita: 835,            // USD (2025)[17]
    internetPen: 48.15,           // % (апрель 2025)[18]
    urbanisation: 55.3,           // % (2025)[28]
    market2024: 0.3485,           // млрд USD last-mile (2024)[51]
    cagr: 9.4,                    // % прогноз 2025–2031 last-mile[51]
    codShare: 23,                 // % COD e-commerce (2023)[44]
    hhi: 1200,                    // индекс концентрации (оценочно)
    lpiScore: 2.3,                // Logistics Performance Index (2023 est.)
    amliRank: null,               // данных нет
    aggPen: 30.0,                 // % агрегационного спроса (оценочно)
    competitors: [
        { name: 'Jumia Logistics', type: 'aggregator', share: 20.0, ecommerce_focus: true },
        { name: 'Gokada', type: 'on-demand', share: 15.0, ecosystem_integrated: true },
        { name: 'Kobo360', type: 'aggregator', share: 12.0, tech_platform: true },
        { name: 'GIG Logistics', type: 'traditional', share: 10.0, local_leader: true },
        { name: 'DHL Express Nigeria', type: 'traditional', share: 8.0, global_network: true },
        { name: 'Aramex Nigeria', type: 'traditional', share: 5.0, b2b_focus: true }
    ],
    payMix: {
        mobile_money: 40,        // % мобильных кошельков
        cod: 23,                 // % наложенного платежа
        card: 25,                // % карт и BNPL
        bank_transfer: 7,        // % банковских переводов
        wallet: 5                // % e-wallet
    },
    regulation: {
        fdi: 100,                      // % допускается FDI
        licence: 'Не требуется',       // лицензия на внутренние перевозки
        dataProtection: 'NDPA 2023'    // Закон о защите данных
    },
    swot: {
        strengths: [
            'Крупнейший рынок CEP в Африке',
            'Быстрое развитие mobile money (M-Pesa, Airtel Money)',
            'Рост интернет-покрытия (>48%)'
        ],
        weaknesses: [
            'Низкий LPI Score (≈2.3) указывает на проблемы с инфраструктурой',
            'Высокая доля COD увеличивает затраты оборотного капитала',
            'Региональное неравномерное покрытие дорог'
        ],
        opportunities: [
            'Увеличение e-commerce (до $33 млрд к 2026)[44]',
            'Инвестиции в цифровую инфраструктуру и дороги',
            'Автоматизация last-mile (дроны, локеры)'
        ],
        threats: [
            'Высокая конкуренция informal-курьеров',
            'Регулятивные изменения и бюрократия',
            'Валютная волатильность и рост цен на топливо'
        ]
    },
    sources: [
        'Report Projects Nigeria’s Population To Cross 237 Million By 2025'[31],
        'Nigeria’s GDP per capita shrinks to $835 —IMF'[17],
        'Nigeria\'s Broadband Penetration Rises To 48.15%[18]',
        'Population of Nigeria. 2025 demographics'[28],
        'Middle East Last Mile Delivery Market Report: Nigeria segment'[51],
        'Nigeria\'s ecommerce transaction to reach $33bn by 2026'[44]
    ]
},
// Вставьте этот код в файл app.js внутри объекта DETAILED_COUNTRIES
YEM: {
